...
const Template1 = (props) => {
  ...
  return (
    <Paper
      ...
      />
      <Container >
        <TemplateHeading color={"#448aff"} title={"Professional Experience"} />
        <ul style={{ paddingBottom: 10 , width:20 }}>
        ...
        <TemplateHeading color={"#448aff"} title={"Education"} />
        <TemplateEducationComponent education={educationinfo} />
        <TemplateHeading color={"#448aff"} title={"Key Skills"} />
